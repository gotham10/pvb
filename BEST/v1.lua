...
local function runSafeLocation()
    ...
    table.insert(_G.ScriptManager.Connections["SafeLocation"], UserInputService.InputBegan:Connect(function(input, gp)
...
adminTitle.Size = UDim2.new(1, -40, 0, 35)
...
createToggle("Safe Location (Press T)", "SafeLocation", runSafeLocation)
