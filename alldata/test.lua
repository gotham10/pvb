...
if queueteleport and SCRIPT_URL ~= "YOUR_RAW_GITHUB_URL_HERE" then
...
elseif SCRIPT_URL == "YOUR_RAW_GITHUB_URL_HERE" then
    print("Scanner Script: Please set the SCRIPT_URL variable for re-execution to work.")
end
