    ...
    local function RunScanner()
        ...
        local function buildScanResults()
            ...
            for _,p in ipairs(Plrs:GetPlayers()) do
                if Config.HIDE_MY_DATA and p.Name == MY_USERNAME then
                    continue
                end
                ...
                for _, itemData in ipairs(allItems) do
                    ...
                    if typ == "Plant" then
                        ...
                        searchList = Config.ScanPlants
                        generalThreshold = Config.MAX_KG_THRESHOLD_PLANT
                    else
                        list = pData.Brainrots.Items
                        searchList = Config.ScanBrainrots
                        generalThreshold = Config.MAX_KG_THRESHOLD_BRAINROT
                    end
                    ...
                    if typ == "Brainrot" and itemData.Mutation then
                        isGlobalMutationWhitelisted = Config.ScanMutations[itemData.Mutation]
                    end
        ...
        local function createUI()
            ...
            hideDataButton.MouseButton1Click:Connect(function()
                Config.HIDE_MY_DATA = not Config.HIDE_MY_DATA
                updateHideButtonVisuals()
            end)
