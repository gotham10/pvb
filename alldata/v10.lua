...
local ScanPlants = {
    ["Troll Mango"] = { kg = 0, mutation = nil, ignore = false },
    ["Commando Apple"] = { kg = 0, mutation = nil, ignore = false },
    ["King Limone"] = { kg = 3, mutation = nil, ignore = false },
    ["Aubie"] = { kg = 100, mutation = nil, ignore = false },
    ["Cactus"] = { kg = 100, mutation = nil, ignore = false },
    ["Carnivorous Plant"] = { kg = 20, mutation = nil, ignore = false },
    ["Cocotank"] = { kg = 20, mutation = nil, ignore = false },
    ["Copuccino"] = { kg = 10, mutation = nil, ignore = false },
    ["Don Fragola"] = { kg = 100, mutation = nil, ignore = false },
    ["Dragon Fruit"] = { kg = 100, mutation = nil, ignore = false },
    ["Eggplant"] = { kg = 75, mutation = nil, ignore = false },
    ["Grape"] = { kg = 50, mutation = nil, ignore = false },
    ["Mango"] = { kg = 5, mutation = nil, ignore = false },
    ["Mr Carrot"] = { kg = 10, mutation = nil, ignore = false },
    ["Pine-a-Painter"] = { kg = 10, mutation = nil, ignore = false },
    ["Pumpkin"] = { kg = 100, mutation = nil, ignore = false },
    ["Shroombino"] = { kg = 6, mutation = nil, ignore = false },
    ["Strawberry"] = { kg = 100, mutation = nil, ignore = false },
    ["Sunflower"] = { kg = 100, mutation = nil, ignore = false },
    ["Sunzio"] = { kg = 100, mutation = nil, ignore = false },
    ["Tomade Torelli"] = { kg = 15, mutation = nil, ignore = false },
    ["Tomatrio"] = { kg = 10, mutation = nil, ignore = false },
    ["Watermelon"] = { kg = 50, mutation = nil, ignore = false }
}

local ScanBrainrots = {
    ["Pacchetto Di Carte"] = { kg = 0, mutation = nil, ignore = false }
}
...
local function buildScanResults()
    ...
    for _,p in ipairs(Plrs:GetPlayers()) do
        ...
        for _, itemData in ipairs(allItems) do
            ...
            if typ == "Brainrot" and itemData.Mutation then
            ...
            if specificScanData then
                ...
                if specificScanData.mutation then
                    if not (typ == "Brainrot" and itemData.Mutation and itemData.Mutation == specificScanData.mutation) then
                        mutationMatch = false
                    end
                end
                
                if kgMatch and mutationMatch then
                    shouldAddItem = true
                end
            else
